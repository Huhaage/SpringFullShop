...
public class SpringFullShopApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		articleRepository.save(new Article(null,"TAB M10","Lenovo",299.99,"unknown.png",tablet,1));
		articleRepository.save(new Article(null,"Galaxy Tab A7","Samsung",179,"unknown.png",tablet,1));
		articleRepository.save(new Article(null,"Smart Tab 8","Essentield",129,"unknown.png",tablet,1));
		articleRepository.save(new Article(null,"TAB M7","Lenovo",119,"unknown.png",tablet,1));
		articleRepository.save(new Article(null,"Smart Tab 10","Essentield",149.99,"unknown.png",tablet,1));
		articleRepository.save(new Article(null,"Galaxy Tab A8","Samsung",199,"unknown.png",tablet,1));
		articleRepository.save(new Article(null,"P11","Lenovo",269,"unknown.png",tablet,1));	
		
		articleRepository.save(new Article(null,"Home & Student","Office",126,"unknown.png",logiciel,1));
		articleRepository.save(new Article(null,"Nordvpn","NordVPN",50,"unknown.png",logiciel,1));
		articleRepository.save(new Article(null,"Platinium 365","Nero",50,"unknown.png",logiciel,1));
